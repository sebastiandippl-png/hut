...
$activityLabel = static function (string $type): array {
    return match ($type) {
        ...
        'scheduled_food' => ['🗓️', 'picked a cook date for'],
...
<div class="landing-grid" data-landing-page>
    ...
    <section class="landing-card landing-card--activity landing-card--span4 landing-card--activity-feed" aria-labelledby="landing-recent-activity-title">
